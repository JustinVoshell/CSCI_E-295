...
void pp_type_specifier_(struct node* node)
{
	...
	{
		case INTEGER_DATA_VOID           : { c_type_spec = "void";               break; }
		case INTEGER_DATA_SIGNED_CHAR    : { c_type_spec = "signed char";        break; }
		case INTEGER_DATA_UNSIGNED_CHAR  : { c_type_spec = "unsigned char";      break; }
		case INTEGER_DATA_SIGNED_SHORT   : { c_type_spec = "signed short int";   break; }
		case INTEGER_DATA_UNSIGNED_SHORT : { c_type_spec = "unsigned short int"; break; }
		case INTEGER_DATA_SIGNED_INT     : { c_type_spec = "signed int";         break; }
		case INTEGER_DATA_UNSIGNED_INT   : { c_type_spec = "unsigned int";       break; }
		case INTEGER_DATA_SIGNED_LONG    : { c_type_spec = "signed long int";    break; }
		case INTEGER_DATA_UNSIGNED_LONG  : { c_type_spec = "unsigned long int";  break; }
		default: break;
	}
